...
class ImageMapperSubtask(with_metaclass(abc.ABCMeta, pipeBase.Task)):
    ...
    def run(self, subExposure, expandedSubExposure, fullBBox, **kwargs):
        ...
        Returns
        -------
        A `lsst.pipe.base.Struct containing the result of the `subExposure` processing,
...
class ImageReducerSubtask(pipeBase.Task):
    ...
    def run(self, mapperResults, exposure, **kwargs):
        ...
        that the `lsst.pipe.base.Struct`s in the `mapperResults` list
        ...
        ----------
        mapperResults : list
            list of `lsst.pipe.base.Struct` returned by `ImageMapperSubtask.run`.
        ...
        (named 'exposure') or a list (named 'result'), depending on
    ...
    def _constructPsf(self, mapperResults, exposure):
        ...
        Returns
        -------
        A `lsst.meas.algorithms.CoaddPsf` constructed from the PSFs of the individual
        subExposures.
        """
...
class ImageMapReduceTask(pipeBase.Task):
    ...
    def _runMapper(self, exposure, doClone=False, **kwargs):
        ...
        Returns
        -------
        a list of `lsst.pipe.base.Struct` as returned by `mapperSubtask.run`.
        """
    ...
    def _reduceImage(self, mapperResults, exposure, **kwargs):
        ...
        **kwargs :
        ...
        Returns
        -------
        Output of `reducerSubtask.run` which is a `lsst.pipe.base.Struct`.
        """
