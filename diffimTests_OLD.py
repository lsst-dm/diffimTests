...
def makeFakeImages(imSize=None, sky=300., psf1=None, psf2=None, offset=None,
                   scintillation=0., psf_yvary_factor=0.,
                   theta1=0., theta2=-45., varFlux1=0, varFlux2=1500,
                   variablesNearCenter=True, avoidBorder=True,
                   im2background=0., n_sources=500, sourceFluxRange=None, sourceFluxDistrib='exponential',
                   psfSize=21, seed=66, fast=True, verbose=False, **kwargs):
...
class DiffimTest(object):
    ...
    def doALInStack(self, doWarping=False, doDecorr=True, doPreConv=False):
        ...
        config.kernel.active.spatialKernelOrder = 0
    ...
    def runTest(self, subtractMethods=['ALstack', 'ZOGY', 'ZOGY_S', 'ALstack_noDecorr'],
                zogyImageSpace=True, returnSources=False, **kwargs):
